<!-- controllo sessione lato server -->
<?php
...
<head>
    ...
    <title>Wannabe Novelist - Upload Your Novel</title>
    ...
    <script>
        ...
        function updatePreview() {
            ...
            document.getElementById("preview-genre").innerText = document.getElementById("genre").value || "Fantasy";
        ...
        function uploadNovel(title, author,file) {
            ...
            fetch("upload_novel.php", {
                ...
                .catch(error => {
                    ...
                    document.getElementById("error-message").innerText = "Error uploading file. Try again later.";
                    document.getElementById("error-message").style.display = "block";
                });
        }
    ...
    <div class="main-content">
            ...
            <form>
                ...
                <div class="form-section">
                    ...
                    <div class="radio-group">
                        ...
                        <div class="radio-option">
                            <input type="radio" id="premium" name="option" value="premium" checked>
                ...
                <div class="form-section">
                    ...
                    <div class="radio-group">
                        <div class="radio-option">
                            <input type="radio" id="short" name="novel-type" value="short" onchange="updateFileInput()">
                            <label for="short">Short</label>
                        </div>
                        <div class="radio-option">
                            <input type="radio" id="long" name="novel-type" value="long" onchange="updateFileInput()" checked>
        ...
        <div class="preview-section">
            ...
            <div class="preview-info">
                ...
                <p><span class="preview-label">Genre:</span> <span id="preview-genre">Fantasy</span></p>
                <p><span class="preview-label">Option:</span> <span id="preview-option">Premium</span></p>
                <p><span class="preview-label">Novel Type:</span> <span id="preview-type">Long</span></p>
